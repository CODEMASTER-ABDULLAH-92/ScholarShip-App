...
const UserDashBoard = () => {
  ...
  let [currentTotal1, setCurrentTotal1] = useState(0);
  ...
  useEffect(() => {
    profilePercentage();
  }, [status, statusAddress, status, currentTotal1, statusDocs]);
  ...
  /**
   * Handles user logout
   * Clears cookies, local storage and navigates to home page
   */
      ...
      <div className="flex-1 p-6 md:p-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`${stat.bg} p-6 rounded-xl shadow-sm flex items-center justify-between`}
            >
              <div>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
                ...
                <div>
                  <NavLink
                    to={status === "Completed" ? "" : "/personal-Info"}
                    className={`${
              ...
              <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
                ...
                <div>
                  <NavLink
                    to={statusAddress === "Completed" ? "#" : "/address"}
                    onClick={(e) => {
                      if (status === "Completed") {
                        e.preventDefault();
              ...
              <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
                ...
                <div>
                  <NavLink
                    to={status === "Completed" ? "" : "/education"}
                    className={`${
                      statusEdu === "Completed" ? "cursor-not-allowed" : ""
                    } font-medium`}
                  >
                    Education
                  </NavLink>
              ...
              <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
                ...
                <div>
                  <NavLink
                    to={status === "Completed" ? "" : "/docs"}
                    className={`${
                      statusDocs === "Completed" ? "cursor-not-allowed" : ""
                    } font-medium`}
                  >
                    Documents
                  </NavLink>
